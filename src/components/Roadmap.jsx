      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
                ...
                <div className={`w-full md:w-5/12 ml-24 md:ml-0 ${
                  ...
                  >
                    <div className="flex flex-wrap items-center gap-3 mb-4">
                      ...
                      <span className="text-sm font-semibold" style={{ color: '#333' }}>{milestone.phase}</span>
                    </div>
                    <h3 className="text-xl md:text-2xl font-bold mb-3" style={{ color: '#000' }}>{milestone.title}</h3>
                    <p className="text-base md:text-lg mb-4" style={{ color: '#333', lineHeight: '1.6' }}>{milestone.description}</p>
        ...
        >
          <div className="bg-[#ff6b9d] rounded-xl p-6 md:p-8 lg:p-10 text-white shadow-xl max-w-3xl mx-auto border-2 border-black">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">Join Us on This Journey</h3>

...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { 
      ...
      fallback: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Cpath fill='white' d='M3 3h18v18H3V3zm2 2v14h14V5H5zm2 2h10v2H7V7zm0 4h10v2H7v-2zm0 4h7v2H7v-2z'/%3E%3C/svg%3E"
    },
    { 
      name: "DexTools", 
      url: "https://www.dextools.io/app/en/solana/pair-explorer/4kAFtWjyzrpx6E7TFVhcVKKDEsxc8H3uYtg7dTnXpump", 
      icon: "/Dextools_Logo.svg",
      fallback: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Cdefs%3E%3ClinearGradient id='grad' x1='0%25' y1='0%25' x2='100%25' y2='100%25'%3E%3Cstop offset='0%25' style='stop-color:white;stop-opacity:1' /%3E%3Cstop offset='100%25' style='stop-color:%23ddd;stop-opacity:1' /%3E%3C/linearGradient%3E%3C/defs%3E%3Cpath fill='url(%23grad)' d='M60 10L10 35l50 25 50-25-50-25zM10 85l50 25 50-25M10 60l50 25 50-25'/%3E%3C/svg%3E"
    },
    { 
      name: "Pump.fun", 
      url: "https://pump.fun/4kAFtWjyzrpx6E7TFVhcVKKDEsxc8H3uYtg7dTnXpump", 
      icon: "https://pump.fun/favicon.ico",
      fallback: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Ccircle cx='12' cy='12' r='10' fill='none' stroke='white' stroke-width='1.5'/%3E%3Cpath fill='white' d='M8 12h8M12 8v8'/%3E%3C/svg%3E"
    },
  ]
      ...
      <div className="container mx-auto relative z-10">
          ...
          <div className="flex justify-center flex-wrap gap-4 md:gap-6 items-center">
            ...
            {dexScreenerLink && (
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="transition-all hover:opacity-80 inline-flex items-center justify-center bg-white rounded-lg border-2 border-black shadow-lg px-4 py-3"
                initial={{ opacity: 0, y: 20 }}
                animate={isInView ? { opacity: 1, y: 0 } : {}}
        ...
        >
          <div className="text-center">
            <motion.div
              className="inline-block bg-white/20 backdrop-blur-sm rounded-full px-8 py-4 border-2 border-black"
